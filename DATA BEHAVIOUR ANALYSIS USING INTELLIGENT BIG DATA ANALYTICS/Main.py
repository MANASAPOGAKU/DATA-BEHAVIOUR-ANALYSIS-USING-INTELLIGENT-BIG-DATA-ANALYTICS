...
main = Tk()
main.title("Data Behavior Analysis Using Intelligent Big Data Analytics")
...
def initSpark():
    ...
    dataset = spark.read.format("csv").option("header",True).load(r"C:\Users\GANESH KUMAR\Downloads\DataBehaviour\DataBehaviour\Dataset\dailymotion.csv")
...
font = ('times', 15, 'bold')
title = Label(main, text='Data Behavior Analysis Using Intelligent Big Data Analytics')
